...
const navigation: AppNavigationItem[] = [
  {
    ...
    href: "/core",
    children: [
      { name: "Chapter 1: Gameplay", href: "/core/chapter-1" },
      { name: "Chapter 2: GM Toolkit", href: "/core/chapter-2" },
      { name: "Chapter 3: Adventurers", href: "/core/chapter-3" },
      { name: "Chapter 4: Exploration", href: "/core/chapter-4" },
      { name: "Chapter 5: Monsters", href: "/core/chapter-5" },
      { name: "Chapter 7: Extras", href: "/core/chapter-7" }
    ]
  }
];
      ...
      <div className="sticky top-0 z-40 bg-panel-1 lg:hidden">
        <Container>
          <div className="flex h-16 items-center">
            ...
            <div className="font-heading text-lg font-bold text-heading-color">
