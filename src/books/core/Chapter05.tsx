...
const Chapter05 = () => {
  return (
    <Page bookTitle="Core Rulebook" title="Monsters" pretitle="Chapter 5:" navigation={navigation}>
      ...
      <Text>
        ...
        at all besides example traits and moves. As with all things in <Em>Thornbound</Em>, monsters
      ...
      <Monster
        ...
        sight="squirming tentacles, intense gaze, faint movement"
        sound="soft slithering, faint clicking, sudden snapping"
        smell="musty earth, damp rock, faintly fishy scent"
      ...
      <Monster
        ...
        sight="majestic soaring, flash of golden fur, knowing eyes"
        sound="beak snap, flutter of feathers, scratching the ground"
        smell="crisp mountain air, faint scent of wild prey"
