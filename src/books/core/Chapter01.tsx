...
const navigation: PageNavigationItem[] = [
  { name: "What is Thornbound?", anchor: "#what-is-thornbound" },
  {
...
const Chapter01 = () => {
  return (
    <Page bookTitle="Core Rulebook" title="Gameplay" pretitle="Chapter 1:" navigation={navigation}>
      <Heading level={2} id="what-is-thornbound">
        What is Thornbound?
      </Heading>
      <Text>
        <StrongEm>Thornbound is a game of cinematic fantasy adventure</StrongEm>. You go on quests,
        delve into dungeons, and explore the wilderness. It's set in a world of your choosing, or
        one you create together—the key being it's a world in need of adventurers.{" "}
        <Em>Thornbound</Em> isn't a setting. That's up to you. This game gives you the rules,
      ...
      <Text>
        <Em>Thornbound</Em> is a tabletop roleplaying game, which this book assumes you're familiar
      ...
      <Text>
        <StrongEm>Thematically</StrongEm>, <Em>Thornbound</Em> draws heavily on the heroic fantasy
        of <Em>Dungeons &amp; Dragons</Em> and wears this influence on its sleeve. It's especially
      ...
      <Text>
        ...
        <Em>Thornbound</Em> is built on draws from a variety of character-driven games, with the
      ...
      <Section title="Conventions in This Book:">
        <List>
          ...
          <List.Item>
            <Strong>Pools</Strong> : In <Em>Thornbound</Em>, “pool” always refers to diminishing
            pools (pg. 13), differing from its broader use in other RPGs.
          </List.Item>
          <List.Item>
      ...
      <Text>
        <Em>Thornbound</Em> is built with the <StrongEm>Moxie</StrongEm> cinematic toolkit, a
        tabletop RPG ruleset that focuses on cinematic action and character-driven gameplay. Below
        is how the key parts tie together and an intro to the game's terms. The rules are explained
        throughout chapters 1 and 2, followed by <StrongEm>examples of play</StrongEm>. The game
        uses a lot of its own terminology, so here's a{" "}
        <StrongEm>basic rundown of the key parts</StrongEm> which you'll encounter throughout the
        rules. Don't worry about understanding all of this right now!
      </Text>
      ...
      <Text>
        <Em>Thornbound</Em> is built with the <Em>Moxie</Em> ruleset and designed for{" "}
