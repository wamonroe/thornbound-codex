...
import AlreadyLooted from "~/svgs/thieves_cant/AlreadyLooted";
import AvoidLeave from "~/svgs/thieves_cant/AvoidLeave";
import BeingWatched from "~/svgs/thieves_cant/BeingWatched";
import CanBeBribed from "~/svgs/thieves_cant/CanBeBribed";
import CannotBeBribed from "~/svgs/thieves_cant/CannotBeBribed";
import CrownTerritory from "~/svgs/thieves_cant/CrownTerritory";
import DangerInside from "~/svgs/thieves_cant/DangerInside";
import DoNotEnter from "~/svgs/thieves_cant/DoNotEnter";
import DoNotGoThisWay from "~/svgs/thieves_cant/DoNotGoThisWay";
import DoNotTrustInside from "~/svgs/thieves_cant/DoNotTrustInside";
import EntryFromAbove from "~/svgs/thieves_cant/EntryFromAbove";
import EntryUnderground from "~/svgs/thieves_cant/EntryUnderground";
import EscapeRoute from "~/svgs/thieves_cant/EscapeRoute";
import Fence from "~/svgs/thieves_cant/Fence";
import GetOutFast from "~/svgs/thieves_cant/GetOutFast";
import GuardedLocation from "~/svgs/thieves_cant/GuardedLocation";
import GuardsPatrolHere from "~/svgs/thieves_cant/GuardsPatrolHere";
import GuildProtected from "~/svgs/thieves_cant/GuildProtected";
import GuildTerritory from "~/svgs/thieves_cant/GuildTerritory";
import HeistBeingPlanned from "~/svgs/thieves_cant/HeistBeingPlanned";
import HiddenDoor from "~/svgs/thieves_cant/HiddenDoor";
import HowToUse from "~/svgs/thieves_cant/HowToUse";
import MagicCasterHere from "~/svgs/thieves_cant/MagicCasterHere";
import MeetingPlace from "~/svgs/thieves_cant/MeetingPlace";
import MonstersInside from "~/svgs/thieves_cant/MonstersInside";
import NoGuardPatrol from "~/svgs/thieves_cant/NoGuardPatrol";
import NotWorthRobbing from "~/svgs/thieves_cant/NotWorthRobbing";
import NothingValuableInside from "~/svgs/thieves_cant/NothingValuableInside";
import ProtectedByGang from "~/svgs/thieves_cant/ProtectedByGang";
import ProtectedByMagic from "~/svgs/thieves_cant/ProtectedByMagic";
import SafeForGuild from "~/svgs/thieves_cant/SafeForGuild";
import SafeHouse from "~/svgs/thieves_cant/SafeHouse";
import SafeThisWay from "~/svgs/thieves_cant/SafeThisWay";
import SecuredLocation from "~/svgs/thieves_cant/SecuredLocation";
import SpeakTheWord from "~/svgs/thieves_cant/SpeakTheWord";
import SymbolWrapper from "~/svgs/thieves_cant/SymbolWrapper";
import TrapsAhead from "~/svgs/thieves_cant/TrapsAhead";
import TrustPersonInside from "~/svgs/thieves_cant/TrustPersonInside";
import TurnInDirection from "~/svgs/thieves_cant/TurnInDirection";
import UnsecuredLocation from "~/svgs/thieves_cant/UnsecuredLocation";
import ValuablesInside from "~/svgs/thieves_cant/ValuablesInside";
import Wealthy from "~/svgs/thieves_cant/Wealthy";
import WellGuarded from "~/svgs/thieves_cant/WellGuarded";
import WorthRobbingIfPossible from "~/svgs/thieves_cant/WorthRobbingIfPossible";

const Chapter07 = () => {
  return (
    <Page bookTitle="Core Rulebook" title="Extras" pretitle="Chapter 7:">
      <Heading level={2}>Flavors of Fantasy</Heading>
      <Text>
        With a few quick rules tweaks, you can shift the base assumptions of <Em>Thornbound</Em>{" "}
        over to other genres of fantasy, or just more to your table's liking.
      </Text>
      ...
      <Section title="Heroic Fantasy" titleVariant="solid">
        ...
        <List variant="unordered">
          <List.Item>
            Default <Em>Thornbound</Em> rules.
          </List.Item>
        </List>
      </Section>
      ...
      <Heading level={3}>Ficton Pillars</Heading>
      <Text>
      ...
      <Text>
        ...
        offensive, one defensive, and one utility. Additionally, each role features a d6 table with
        creative ideas for how to spend suspense in response to common worst-case scenarios that
        role encounters.
      </Text>
      <MonsterRole
        type="blaster"
      ...
      <MonsterRole
        type="lurker"
        description="Stealthy stalkers who strike from concealment, waiting patiently for the perfect moment to attack. However, they falter when exposed or in prolonged fights."
        strengths={["Perfectly silent", "Watchful"]}
        weakness="Fragile when revealed"
        offensiveMove="Ambush"
        defensiveMove="Vanish"
        utilityMove="Misdirect"
        wants="to only have to strike once."
        doesntWant="to have to risk their own neck."
        tableTitle="When Their Cover is Blown"
        tableRows={[
          "Strikes quickly to silence the **nearest threat**.",
          "Flees into the shadows, **looking for new cover**.",
          "Throws debris or objects to **create a distraction**.",
          "**Slinks** behind an ally or stronger creature.",
          "Unleashes a **flurry of wild attacks**.",
          "**Abandons** the fight entirely, escaping to safety."
        ]}
      />
      <MonsterRole
        type="marksman"
        description="Precise sharpshooters who excel at picking off targets from a distance. However, they are vulnerable when caught in melee or forced to move quickly."
        strengths={["Lethal precision", "Exceptional range"]}
        weakness="Panics close up"
        offensiveMove="Piercing Shot"
        defensiveMove="Take Cover"
        utilityMove="Spot Weakness"
        wants="to focus completely on the key threat."
        doesntWant="to shoot into chaotic situations."
        tableTitle="When Under Pressure"
        tableRows={[
          "Focuses on the **closest threat** for a critical shot.",
          "**Dives into cover** to avoid incoming attacks.",
          "**Signals allies** to draw enemy attention.",
          "Shifts to **higher ground** for a better vantage point.",
          "Takes a **rapid, less accurate** shot to disrupt foes.",
          "Retreats to **reposition** for the next attack."
        ]}
      />
      <MonsterRole
        type="marauder"
        description="Brutal raiders who thrive in chaos, striking quickly and ruthlessly to overwhelm their foes. However, they falter when their momentum is broken."
        strengths={["Relentless aggression", "Unpredictable"]}
        weakness="Impulsive"
        offensiveMove="Crazy Frenzy"
        defensiveMove="Mad Dash"
        utilityMove="Wreak Havoc"
        wants="to throw the battlefield into chaos."
        doesntWant="to face organized resistance."
        tableTitle="When Their Attack Stalls"
        tableRows={[
          "**Charges forward** recklessly, ignoring safety.",
          "Lashes out at the **closest enemy** in frustration.",
          "Circles their foes, **looking for a weak spot**.",
          "**Rallies allies** with a furious battle cry.",
          "Retreats momentarily to **regain momentum**.",
          "Smashes the environment to **create new chaos**."
        ]}
      />
      <MonsterRole
        type="overseer"
        description="Commanding tacticians who direct allies, manipulating the battlefield to their advantage. However, they struggle when isolated or overwhelmed."
        strengths={["Strategic leadership", "Unwavering authority"]}
        weakness="Relies on subordinates"
        offensiveMove="Unleash Hell!"
        defensiveMove="Rally to me!"
        utilityMove="Make it so!"
        wants="to control the flow of battle."
        doesntWant="to watch their forces fall apart."
        tableTitle="When Their Plans Unravel"
        tableRows={[
          "**Calls for reinforcements** with an urgent shout.",
          "Focuses on eliminating the **biggest threat**.",
          "Blames an ally, sowing discord to **regain control**.",
          "Directs allies to hold the line while they **regroup**.",
          "Retreats to a **safer vantage** point to reassess.",
          "Sacrifices an ally to **buy time** or **ensure survival**."
        ]}
      />
      <MonsterRole
        type="predator"
        description="Persistent hunters who stalk their prey, waiting for the perfect moment to strike. However, they falter if their prey is tenacious."
        strengths={["Relentless pursuit", "Overwhelming strike"]}
        weakness="Overcommits to attacks"
        offensiveMove="Ambush"
        defensiveMove="Evasive Leap"
        utilityMove="Track Down"
        wants="to toy with their prey before the kill."
        doesntWant="to lose sight of their quarry."
        tableTitle="When Their Prey Slips Away"
        tableRows={[
          "Leaps to **cut off** the target's escape.",
          "**Refuses to give up** no matter what.",
          "**Roars**, forcing a mistake.",
          "Circles, creating a trap to **regain control**.",
          "**Strikes wildly** in frustration, hitting all around.",
          "Vanishes, retreating to **wait for another chance**."
        ]}
      />
      <MonsterRole
        type="protector"
        description="Unyielding guardians who shield their allies and endure attacks meant for others. However, they struggle when separated from those they protect."
        strengths={["Unwavering resilience", "Exceptional tactics"]}
        weakness="Limited offense"
        offensiveMove="Setup Ally"
        defensiveMove="Interpose"
        utilityMove="Rally Cry"
        wants="to take a hit meant for whom they protect."
        doesntWant="to lose any piece of their defensive toolkit."
        tableTitle="When an Ally is in Danger"
        tableRows={[
          "Steps in to **block** an incoming attack.",
          "**Draws enemy attention** with a loud challenge.",
          "**Shoves the ally** out of harm's way.",
          "Counters with a heavy blow to **create space**.",
          "Raises a protective barrier to **buy time**.",
          "Sacrifices their position to **shield the ally**."
        ]}
      />
      <MonsterRole
        type="skirmisher"
        description="Agile combatants who excel at hit-and-run tactics, harassing their foes and striking from unexpected angles. However, they falter when pinned down."
        strengths={["Exceptional mobility", "Quick reflexes"]}
        weakness="Fragile"
        offensiveMove="Strike & Move"
        defensiveMove="Dodging Roll"
        utilityMove="Force Back"
        wants="to frustrate the hell out of their foes."
        doesntWant="to face anything faster than them."
        tableTitle="When they Lose the Advantage"
        tableRows={[
          "**Retreats quickly** to regroup and reassess.",
          "Strikes recklessly, hoping to **create an opening**.",
          "**Dodges wildly** to avoid being hit.",
          "Circles, searching for a **weak point** to exploit.",
          "Taunts, trying to **bait enemies** into a mistake.",
          "**Disengages**, vanishing into the fray."
        ]}
      />
      <MonsterRole
        type="swarmer"
        description="Relentless attackers who overwhelm their enemies with sheer numbers, striking from all sides to wear them down. However, they falter when isolated."
        strengths={["Neverending attacks", "Overwhelming numbers"]}
        weakness="Weak individually"
        offensiveMove="Swarm, Swarm!"
        defensiveMove="Scatter!"
        utilityMove="Surround 'em!"
        wants="to give enemies no room at all to think."
        doesntWant="to be separated from each other even a bit."
        tableTitle="When Their Numbers Thin"
        tableRows={[
          "**Presses harder**, with reckless desperation.",
          "Retreats momentarily to **regroup**.",
          "**Calls for reinforcement** with frantic signals.",
          "Regroups, pulling forces into **defensive cluster**.",
          "Scatters, trying to **avoid further losses**.",
          "**Breaks**, abandoning the fight entirely."
        ]}
      />
      <MonsterRole
        type="tactician"
        description="Clever strategists who manipulate the battlefield, exploiting every weakness they find. However, they struggle when their plans fall apart."
        strengths={["Always prepared", "Good under pressure"]}
        weakness="Trusts in their plans"
        offensiveMove="Flanking Strike"
        defensiveMove="Tactical Retreat"
        utilityMove="Create Weakness"
        wants="to outthink their foes."
        doesntWant="to be outmaneuvered."
        tableTitle="When a Plan Fails"
        tableRows={[
          "Redirects allies to **regroup and recover**.",
          "Focuses on a **single target** to salvage the situation.",
          "Orders a retreat to **reevaluate** the fight.",
          "Shifts their attention to a **new opportunity**.",
          "**Sacrifices weaker assets** to regain momentum.",
          "**Lashes out** in frustration, acting recklessly."
        ]}
      />
      <MonsterRole
        type="trickster"
        description="Cunning deceivers who thrive on confusion, turning the tide of battle with guile. However, they crumble when their tricks are exposed or fail."
        strengths={["Master of deception", "Quick, unpredictable"]}
        weakness="Fragile"
        offensiveMove="Deceptive Strike"
        defensiveMove="Bait and Switch"
        utilityMove="Snatch Weapon"
        wants="their foes to react rashly or overthink the situation."
        doesntWant="to be ignored."
        tableTitle="When Their Tricks Fails"
        tableRows={[
          "Feigns weakness to **lure enemies** closer.",
          "**Dodges frantically**, hoping to regain control.",
          "Mocks enemies to **draw attention away**.",
          "**Escapes**, leaving a decoy in their place.",
          "**Reverses** their position, surprising the opponent.",
          "**Lashes out** in desperation to cover the failure."
        ]}
      />
      ...
      <Text>
        <Strong>Thieves' Cant</Strong> is a secret code of speech, symbols, and gestures used by
        rogues and criminals to communicate plans, warnings, opportunities, or deals in plain sight.
        It is a perfect excuse for anyone with a thiefy background to spend story to learn info on a
        place!
      </Text>
      <Text>
        <Strong allCaps>How to Use</Strong>
      </Text>
      <Grid columns="small">
        <Stack spacing="sm" alignItems="center">
          <HowToUse className="w-16" />
          <Stack alignItems="center">
            <Text size="x-small" allCaps>
        ...
        <Stack spacing="sm" alignItems="center">
          <Stack alignItems="center">
            <SymbolWrapper size="lg">
              <SpeakTheWord className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <TrustPersonInside className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <SafeHouse className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <GuildTerritory className="size-full" />
            </SymbolWrapper>
          </Stack>
          <Stack alignItems="center">
            <Text size="x-small" allCaps>
        ...
        <Stack spacing="sm" alignItems="center">
          <Stack alignItems="center">
            <SymbolWrapper size="lg">
              <SafeThisWay className="size-full -rotate-90" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <CannotBeBribed className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <GuardsPatrolHere className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <CrownTerritory className="size-full" />
            </SymbolWrapper>
          </Stack>
          <Stack alignItems="center">
            <Text size="x-small" allCaps>
        ...
        <Stack spacing="sm" alignItems="center">
          <Stack alignItems="center">
            <SymbolWrapper size="lg">
              <GetOutFast className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <ValuablesInside className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <MonstersInside className="size-full" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <TurnInDirection className="size-full -rotate-90" />
            </SymbolWrapper>
            <SymbolWrapper size="lg">
              <HiddenDoor className="size-full" />
            </SymbolWrapper>
          </Stack>
          <Stack alignItems="center">
            <Text size="x-small" allCaps>
      ...
      <Section title="Wealth & Safety">
        <Grid>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <NoGuardPatrol className="-mr-1 -ml-1 size-fit" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              No guard patrol
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <WorthRobbingIfPossible className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Worth robbing
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <CanBeBribed className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Can be bribed
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <HeistBeingPlanned className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Heist being planned
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <GuildProtected className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Guild protected
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <SafeForGuild className="-mr-1.5 -ml-1.5 size-fit" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Safe for guild
            </Text>
      ...
      <Section title="Danger & Avoidance">
        <Grid>
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <DoNotTrustInside className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Do no trust inside
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <AlreadyLooted className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Already looted
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <NothingValuableInside className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <DangerInside className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Danger inside
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <NotWorthRobbing className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Not worth robbing
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <WellGuarded className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Well guarded
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <MagicCasterHere className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Magic caster here
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <ProtectedByMagic className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Protected by magic
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <ProtectedByGang className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Protected by gang
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <AvoidLeave className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Avoid / leave
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <BeingWatched className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Being watched
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <DoNotGoThisWay className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Do not go this way
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <TrapsAhead className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Traps ahead
            </Text>
      ...
      <Section title="Routes & Places">
        <Grid>
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <GuardedLocation className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Guarded location
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <EntryFromAbove className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Entry from above
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <EntryUnderground className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Entry underground
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <MeetingPlace className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Meeting place
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <HiddenDoor className="-mr-1.5 -ml-1.5 size-fit" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Hidden door
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <EscapeRoute className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Escape Route
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <DoNotEnter className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Do not enter
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <UnsecuredLocation className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Unsecure location
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <SecuredLocation className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Secure location
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <TurnInDirection className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Turn in direction
            </Text>
          ...
          <Stack direction="row" alignItems="center" spacing="sm">
            <SymbolWrapper>
              <SafeThisWay className="size-full" />
            </SymbolWrapper>
            <Text size="x-small" allCaps>
              Safe this way
            </Text>
      ...
      <Text>
        <Strong>Note</Strong>:{" "}
        <Em>
          The Thieves' Cant guide was created by <Strong>Matthew Kessler</Strong> and stolen with
          permission. Thanks!
        </Em>
      </Text>
      ...
      <Text>
        Just as Thornbound assumes knowledge of roleplaying games in general, it also assumes
        knowledge about solo and duet style play. If unfamiliar, there are plenty of resources
        online to figure it out.
      </Text>
      <Text>
        The base rules for Thornbound are already very well-suited for solo RPGs. There are plenty
        of difficulty changes on pg. 137 as well for you to adjust the game, but let's look at why
        Thornbound works out of the box.
      </Text>
      <Text>
      ...
      <Text>
        ...
        Thornbound thrives on spontaneity, making it simple to weave together a randomly generated
      ...
      <Text>
        ...
        ask, and roll. Thornbound's design fosters flow and progress from top to bottom, ideal for
        solo play.
      </Text>
      <Heading level={3}>SOLO PARTY MODE</Heading>
      <Text>
        In Thornbound, solo play is clear with the rules as written, but you can also play as a
        party. In this mode, your primary character, the PC, remains the main focus of the story,
        while the other three party members are simplified secondary characters. This approach lets
        you create the social dynamics of an adventuring party without overwhelming complexity.
      </Text>
      <Text>
      ...
      <Text>
        The following sections collect additional commentary by J.D. Maxwell, author of{" "}
        <Em>Grimwild</Em>, reflecting on the game's design, development, and play experience. These
        pieces are more personal and reflective in tone, offering insight into the creative process
        behind the game.
      </Text>
      ...
      <Text>
        That applies in Thornbound, too—this is the very nature of fiction-first and narrative
        gaming. But here's my addition on that phrase: don't do all of it until after the roll,
        after the mechanics. Before the roll, the player describes their intentions and how they're
        going about it, but leaves room for the dice to decide what happens and picks up narration
        again after the roll.
      </Text>
      <Text>
      ...
      <Text>
        ...
        and the experience they're going for, but Thornbound isn't built for it. Thornbound's built
        to flow.
      </Text>
      <Text>
      ...
      <Text>
        ...
        doom. Vigilance: hint brings a big chunk of that magic into Thornbound.
      </Text>
      <Text>
      ...
      <Text>
        The narrative currency in Thornbound, which I decided to call story because it's as clear as
