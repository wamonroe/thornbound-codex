...
const navigation: PageNavigationItem[] = [
  ...
  { name: "Character Creation", anchor: "#character-creation" },
  { name: "Paths & Talents", anchor: "#paths-and-talents" },
  { name: "Bard", anchor: "#bard" },
  { name: "Berserker", anchor: "#berserker" },
  { name: "Cleric", anchor: "#cleric" },
  { name: "Druid", anchor: "#druid" },
  { name: "Fighter", anchor: "#fighter" },
  { name: "Monk", anchor: "#monk" },
  { name: "Paladin", anchor: "#paladin" },
  { name: "Ranger", anchor: "#ranger" },
  { name: "Rogue", anchor: "#rogue" },
  { name: "Sorcerer", anchor: "#sorcerer" },
  { name: "Warlock", anchor: "#warlock" },
  { name: "Wizard", anchor: "#wizard" }
];
